	...
	private void editPartyBasicDetails(WebDriver driver, ExtentTest step,  String partyName, JSONArray basicDetails) throws Exception {
		...
		try {
			...
			if(basicDetail.has("party_responsibility")) {				
				driver.findElement(By.id(updateDealLocator.getString("select-PartyResponsibility"))).findElement(By.tagName("input")).click();
				Thread.sleep(500);
				utility.selectFromDivMenu(driver, step, driver.findElement(By.id(updateDealLocator.getString("select-PartyResponsibility"))).findElement(By.tagName("ul")), basicDetail.getString("party_responsibility"));
			}
			
			if(basicDetail.has("party_remarks")) {
				driver.findElement(By.id(updateDealLocator.getString("input-PartyRemarks"))).clear();
				driver.findElement(By.id(updateDealLocator.getString("input-PartyRemarks"))).sendKeys(basicDetail.getString("party_remarks"));
			}
